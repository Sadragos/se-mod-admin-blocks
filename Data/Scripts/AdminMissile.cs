...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_LargeMissileTurret), true, "AdminMissileTurret")]
    public class AdminMissileTurret : MyGameLogicComponent
    {
        ...
        public override void UpdateBeforeSimulation100()
        {
            ...
            {
                MyObjectBuilder_AmmoMagazine builder = new MyObjectBuilder_AmmoMagazine() { SubtypeName = "Missile200mm" };
